const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || "https://wytejpxqujzazgyfdobt.supabase.co";
const SUPABASE_KEY = process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || "sb_publishable_HbLV5Jp1xxD4qHFvNnacYA_Kt_AoOvr";
