...
export function AuthGate({ children }: { children: ReactNode }) {
  ...
  if (!session && !demo) return <main className={styles.page}>
    ...
    <aside className={styles.visual}><div><span>12 portales</span><span>Gestión centralizada</span><span>Información segura</span></div><h2>Terrazas de Bel Air</h2><p>Comunidad piloto</p></aside>
  </main>;
